...
def gradient_descent(x1, y1, a, b, c, d, learning_rate):
    ...
    for x1i, y1i in zip(x1, y1):
        deriv_loss_wrt_a += -2*(x1i**3)*(y1i - (a*x1i**3 + b*x1i**2 + c*x1i + d))
        deriv_loss_wrt_b += -2*(x1i**2)*(y1i - (a*x1i**3 + b*x1i**2 + c*x1i + d))
        deriv_loss_wrt_c += -2*(x1i**1)*(y1i - (a*x1i**3 + b*x1i**2 + c*x1i + d))
        deriv_loss_wrt_d += -2*(x1i**0)*(y1i - (a*x1i**3 + b*x1i**2 + c*x1i + d))
...
for epoch in range(1000):
    ...
    print(f"a = {np.round(a,2)}\t b = {np.round(b,2)}\t c = {np.round(c,2)}\t d = {np.round(d,2)}\tloss = {np.round(total_loss,2)}")
